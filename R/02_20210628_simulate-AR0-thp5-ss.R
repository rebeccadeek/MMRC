...
# set parameters
m=50; n=100; t=25; theta=0.5; sigma=0.5
...
# save data
saveRDS(df.ar0, file="20210916-simData-ar0-thetap5-sigma-s.RDS")
saveRDS(ts.mcem, file="20210916-tsmcem-ar0-thetap5-sigma-s.RDS")