...
# set parameters
m=50; n=100; t=25; theta=4; sigma=1.3
...
# save data
saveRDS(df.ar0, file="20210916-simData-ar0-theta4-sigma-l.RDS")
saveRDS(ts.mcem, file="20210916-tsmcem-ar0-theta4-sigma-l.RDS")