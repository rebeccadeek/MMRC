...
# set parameters
m=500; n=100; t=25; theta=0; sigma=1.3
...
saveRDS(out, file="20211006_simData-ar0-theta0-sigma-l-nopval.RDS")
...
# save data
saveRDS(out, file="20211217_simData-ar0-theta0-sigma-l.RDS")
